...
public class MakeInformationSchema {
	...
	public static void initilize(String location) {
		try {
			 ...
			 */
			RandomAccessFile schemataTableFile = new RandomAccessFile(location+"information_schema.schemata.tbl", "rw");
			RandomAccessFile tablesTableFile = new RandomAccessFile(location+"information_schema.table.tbl", "rw");
			RandomAccessFile columnsTableFile = new RandomAccessFile(location+"information_schema.columns.tbl", "rw");
