...
public class Tokenization {
	public static final String INPUT_DIRECTORY="C:\\Workspace\\Github\\Information Retrieval\\Tokenization\\Tokenization\\Stemming\\src\\Cranfield\\";
	...
	public void setTokenDictionary(Map<String, Token> tokenDictionary) {
		this.tokenDictionary = tokenDictionary;
	}
	public List<Term> getTokenList() {
		return tokenList;
	}
	public void setTokenList(List<Term> tokenList) {
